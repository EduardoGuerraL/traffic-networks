...
class DataImagesForNodes:
    ...
    def __init__(self, path_dir_screenshots:str, path_dir_network_data: str):
        """
        Para crear un NodesdataFrame que tenga los datos de las imagenes obtenidas de Google.
    ...
    def addColumnToDataFrame(self, dict_to_add: dict , column_name:str):
        """
        Agrega una columna al NodesdataFrame.

        Args:
            NodesdataFrame: DataFrame al que agregamos los datos
    ...
    def updateDataFromGoogleImages(self, name_file_dataFrame:str):
        """
        Una vez creado el dataframe, como las imagenes se van actualizando, aparecen nuevas y no estan esos datos, por lo que 
        es necesario agregar columnas al dataframe.
        """
...
class DataImagesForEdges:
    ...
    def __init__(self, path_dir_screenshots:str, path_dir_network_data: str):
        ...
        """
        self.PromEdgedataFrame = pd.DataFrame()
        self.IntEdgedataFrame = pd.DataFrame()
        self.MaxEdgedataFrame = pd.DataFrame()
        self.makeDataFrame(self.conections, "conección", "indice")
        """
    ...
    def addTrafficColorToDataFrame(self):
        ...
        def addColumnToDataFrame(self, dict_to_add: dict , column_name:str):
            """
            Agrega una columna al PromEdgedataFrame.

            Args:
                PromEdgedataFrame: DataFrame al que agregamos los datos
                dict_to_add(dict): Datos en forma de diccionario que agregaremos.
                column_name(str): Nombre de los datos.
            Return:
                DataFrame modificado.
