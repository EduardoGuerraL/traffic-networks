...
NameDataComp = ["data/DataNetwork/StreetAsNode/all_data_SimpleNet_new.csv",
            "data/DataNetwork/StreetAsNode/all_data_ComplexNet_new.csv"]

datos_comp = pd.read_csv(NameDataComp[1])

## Datos observacional

NameDataObs = ["data/DataImages/In_Streets_Coord/Detallado/DataStreetDetR1S1_mean.csv",
...
datos_obs = pd.read_csv(NameDataObs[4])
...
plt.scatter(Slopes, Kurtosis, label = "kurt")
plt.scatter(Slopes, Skewness, label = "skew")
plt.legend()
plt.show()