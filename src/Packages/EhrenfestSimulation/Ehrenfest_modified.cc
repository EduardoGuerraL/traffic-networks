...
int main()
{
    ...
    string archivo_matriz_adjacencia = "data/DataNetwork/StreetAsNode/ComplexNet_adjMatrix.txt";
    string archivo_guardado_estados = "ComplexNet_EhrMod_10mA_500MT.txt";
