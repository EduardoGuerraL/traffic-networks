...
int main()
{
    ...
    string archivo_matriz_adjacencia = "data/DataNetwork/StreetAsNode/txtes/SimpleNet_adjMatrix.txt";
    string archivo_guardado_estados = "SimpleNet_Ehr_10mA_500MT.txt";
